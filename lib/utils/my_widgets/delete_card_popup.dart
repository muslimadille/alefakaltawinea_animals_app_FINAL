...
class DeleteCradPopupScreen extends StatefulWidget {
  final Function onOkPressed;
  final String content;
  const DeleteCradPopupScreen({required this.content,required this.onOkPressed,Key? key}) : super(key: key);

  @override
  State<DeleteCradPopupScreen> createState() => _DeleteCradPopupScreenState();
}

class _DeleteCradPopupScreenState extends State<DeleteCradPopupScreen> with InputValidationMixin{
